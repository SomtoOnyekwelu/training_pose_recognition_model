...
from ...train_pose_inference.src import utils as utils
...
class Test_PoseInferencePipeline:
    ...
    class Test_predict_image:
        ...
        def make_example_PoseInferencePipeline(self):
            # Fixture creation
            path_to_example_direct_model = r"pose_model_pipeline\tests\test_assets\example_direct_model_10_classes.pkl"

            path_to_its_pose_label_encoder = r"pose_model_pipeline\tests\test_assets\example_pose_label_encoder_10_classes_its_pair.pkl"

            example_PoseInferencePipeline = ip.PoseInferencePipeline(path_to_example_direct_model, path_to_its_pose_label_encoder)
        ...
        def test_no_person_in_image(self, make_example_PoseInferencePipeline):
            ...
            path_to_no_person_image = r"pose_model_pipeline\tests\samples\no_person_image.jpg"
        ...
        path_to_all_one_person_images = r"pose_model_pipeline\tests\samples\one_person_images_different_angles_distances_sizes"
        ...
        path_to_all_three_person_images = r"pose_model_pipeline\tests\samples\three_person_images_different_angles_distances_sizes"
        @pytest.mark.parametrize(
        ...
        def _correct_count_of_PlotLabelToDraw(self, a_list_of_PoseLabelToDraw: list[ip.PoseLabelToDraw], expected_length: int) -> bool:
            ...
            print(f"""Correct count = 3,
                  Actual count = {len(a_list_of_PoseLabelToDraw)}""")
